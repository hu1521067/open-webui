...
from tc_webui.models.groups import Groups, GroupModel, GroupUpdateForm, GroupForm
...
from tc_webui.utils.misc import parse_duration
from tc_webui.utils.auth import get_password_hash, create_token
...
class OAuthManager:
    ...
    def update_user_groups(self, user, user_data, default_permissions):
        ...
        log.debug(
            f"All groups available in TCWebUI: {[g.name for g in all_available_groups]}"
        )
