from tc_webui.utils.task import prompt_template, prompt_variables_template
...
def remove_tc_webui_params(params: dict) -> dict:
    """
    Removes TCWebUI specific parameters from the provided dictionary.

    Args:
        params (dict): The dictionary containing parameters.

    Returns:
        dict: The modified dictionary with TCWebUI parameters removed.
    """
    tc_webui_params = {
...
def apply_model_params_to_body_openai(params: dict, form_data: dict) -> dict:
    params = remove_tc_webui_params(params)
