...
from tc_webui.models.files import (
    FileForm,
    FileModel,
    FileModelResponse,
    Files,
...
from tc_webui.routers.knowledge import get_knowledge, get_knowledge_list
from tc_webui.routers.retrieval import ProcessFileForm, process_file
from tc_webui.routers.audio import transcribe
...
def upload_file_handler(
    ...
    try:
        ...
        contents, file_path = Storage.upload_file(
            ...
            filename,
            {
                "TCWebUI-User-Email": user.email,
                "TCWebUI-User-Id": user.id,
                "TCWebUI-User-Name": user.name,
                "TCWebUI-File-Id": id,
            },
        )
