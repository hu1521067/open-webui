...
from tc_webui.retrieval.loaders.external_document import ExternalDocumentLoader

from tc_webui.retrieval.loaders.mistral import MistralLoader
from tc_webui.retrieval.loaders.datalab_marker import DatalabMarkerLoader
    ...
    def _get_loader(self, filename: str, file_content_type: str, file_path: str):
        ...
        if (
            ...
            if not api_base_url or api_base_url.strip() == "":
                api_base_url = "https://www.datalab.to/api/v1/marker"  # https://github.com/tc-webui/tc-webui/pull/16867#issuecomment-3218424349
