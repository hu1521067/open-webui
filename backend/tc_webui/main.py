...
from tc_webui.utils import logger
from tc_webui.utils.audit import AuditLevel, AuditLoggingMiddleware
from tc_webui.utils.logger import start_logger
from tc_webui.socket.main import (
    app as socket_app,
...
from tc_webui.routers.retrieval import (
...
from tc_webui.internal.db import Session, engine

from tc_webui.models.functions import Functions
from tc_webui.models.models import Models
from tc_webui.models.users import UserModel, Users
from tc_webui.models.chats import Chats
...
from tc_webui.utils.models import (
    get_all_models,
    get_all_base_models,
    check_model_access,
)
from tc_webui.utils.chat import (
    generate_chat_completion as chat_completion_handler,
    chat_completed as chat_completed_handler,
    chat_action as chat_action_handler,
)
from tc_webui.utils.embeddings import generate_embeddings
from tc_webui.utils.middleware import process_chat_payload, process_chat_response
from tc_webui.utils.access_control import has_access
...
from tc_webui.utils.plugin import install_tool_and_function_dependencies
from tc_webui.utils.oauth import OAuthManager
from tc_webui.utils.security_headers import SecurityHeadersMiddleware
from tc_webui.utils.redis import get_redis_connection

from tc_webui.tasks import (
...
from tc_webui.utils.redis import get_sentinels_from_env
...
v{VERSION} - copyright ：实验室项目，最终用户少于50人.
...
if ENABLE_OTEL:
    from tc_webui.utils.telemetry.setup import setup as setup_opentelemetry
    ...
    try:
        ...
        async with aiohttp.ClientSession(timeout=timeout, trust_env=True) as session:
            async with session.get(
                "https://api.github.com/repos/tc-webui/tc-webui/releases/latest",
...
async def get_current_usage(user=Depends(get_verified_user)):
    """
    Get current usage statistics for TC WebUI.
